...
//        $this->testAjoutPanier($manager);
    ...
    public function loadProduits(objectManager $manager){
        ...
        $produits = [
            ['id' => 1,'nom' => 'Enveloppes (50p)', 'prix' => '2', 'typeProduit_id' => '1', 'photo' => 'enveloppes.jpeg'],
        ...
        foreach ($produits as $produit)
        {
            ...
            $new_produit->setDisponible(true);
            $new_produit->setTypeProduit($typeProduit[$produit['typeProduit_id']]);
    ...
    public function loadEtatsCommandes(objectManager $manager)
    {
        ...
        $etat2 = new Etat();
        $etat2->setNom('A prépare');
        $manager->persist($etat2);
        $etat3 = new Etat();
        $etat3->setNom('Expédié');
